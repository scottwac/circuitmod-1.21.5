...
public class ElectricCarpet extends BlockWithEntity {
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        if (!world.isClient()) {
            ...
            if (blockEntity instanceof IPowerConnectable) {
                ...
                Circuitmod.LOGGER.info("[ELECTRIC-CARPET] Block placed at {}, attempting network connection", pos);
            }
        }
    }
    ...
    public void scheduledTick(BlockState state, net.minecraft.server.world.ServerWorld world, BlockPos pos, net.minecraft.util.math.random.Random random) {
        ...
        if (blockEntity instanceof IPowerConnectable) {
            ...
            Circuitmod.LOGGER.info("[ELECTRIC-CARPET] Scheduled tick at {}, checking network connections", pos);
        }
    }
